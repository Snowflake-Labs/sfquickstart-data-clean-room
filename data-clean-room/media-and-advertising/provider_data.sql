...
create or replace secure view dcr_samp_provider_db.cleanroom.provider_customers_vw as select * from  dcr_samp_provider_db.shared_schema.customers;
create or replace secure view dcr_samp_provider_db.cleanroom.provider_exposures_vw as select * from dcr_samp_provider_db.shared_schema.exposures;
create or replace secure view dcr_samp_provider_db.cleanroom.provider_subscriptions_vw as select * from dcr_samp_provider_db.shared_schema.subscriptions;
